...
CREATE TABLE "discovered_domains" (
	...
	"first_discovered_at" timestamp DEFAULT now() NOT NULL,
...
ALTER TABLE "discovered_domains" ADD CONSTRAINT "discovered_domains_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "discovered_domains" ADD CONSTRAINT "discovered_domains_gmail_account_id_gmail_accounts_id_fk" FOREIGN KEY ("gmail_account_id") REFERENCES "public"."gmail_accounts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "discovered_domains_org_gmail_domain_idx" ON "discovered_domains" USING btree ("organization_id","gmail_account_id","domain");--> statement-breakpoint
CREATE INDEX "discovered_domains_org_idx" ON "discovered_domains" USING btree ("organization_id");--> statement-breakpoint
CREATE INDEX "discovered_domains_notified_idx" ON "discovered_domains" USING btree ("notified_at");--> statement-breakpoint
